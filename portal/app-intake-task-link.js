...
function enhanceRows(){
  for(const row of document.querySelectorAll('#taskList .task-row[data-task-id],#priorityQueue .task-row[data-task-id]')){
    ...
    const small=row.querySelector('small');if(small&&!small.textContent.trim())small.textContent='Interesse · kontakt og triage i autorisert mottaksflate';
