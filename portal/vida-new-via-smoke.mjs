...
assert(layer.includes("hasRole('project_owner')")&&layer.includes("hasRole('vida_owner')"),'New VÍA transition control must be hidden from staff roles without manage_program/edit_vida capability');
