...
const NAV_IA_VERSION='2026-09-06a';
...
function normalizeMain(){
  ...
  // Daily work first: Oversikt, Deltakere and Oppgaver get the strongest left-side visibility.
  // Interest/VÍA stays primary, but follows Innsjekk instead of displacing daily work tabs.
