...
assert(src.includes('.runner-controls>.form-version')&&src.includes('#scopeLabel{display:none}'),'Technical template version and scope metadata must not dominate participant form UI');
...
console.log('Participant-only minimal form chrome and metadata invariants OK');
