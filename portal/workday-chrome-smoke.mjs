...
assert(js.includes("WORKDAY_CHROME_VERSION='2026-09-05e'"),'Workday chrome must be versioned for cache busting.');
...
assert(js.includes('Skjema & rutiner')&&js.includes('Mine dokumenter')&&js.includes('secondaryToolLinks'),'Demoted secondary tools must remain reachable from Profile.');
...
assert(css.includes('width:54px!important;height:54px!important')&&css.includes('opacity:.48!important'),'Final active mark must fit inside the nav height and keep its pale linework subdued.');
