...
assert(js.includes("WORKDAY_CHROME_VERSION='2026-09-05f'"),'Workday chrome must be versioned for cache busting.');
...
assert(css.includes('width:58px!important;height:58px!important')&&css.includes('opacity:.44!important'),'Final active mark must use more of the existing nav height while keeping its pale linework subdued.');
...
assert(css.includes('a[href="./onboarding.html"]')&&css.includes('flex-wrap:wrap!important'),'Rolleintroduksjon action must stay inside its guide card on mobile.');
