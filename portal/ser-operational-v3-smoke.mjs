...
expect('auth refresh does not re-render form',js.includes('refreshFormSessionWithoutRerender')&&js.includes('captureInterruptedFormReturn();')&&js.includes("location.replace('./');")&&!js.includes('refreshFormSessionWithoutRerender(){chooseForm'));
