...
// Menu-level "Neste" cue is intentionally disabled for now. Guidance belongs
// in contextual task/action cards until a later IA pass.
...
// Keep swipe independent of the retired Next cue. This is the final, deliberately
// more responsive physical-QA attempt requested by the user.
if(!document.querySelector('script[data-aidme-mobile-swipe]')){
  const swipe=document.createElement('script');
  swipe.src='./app-mobile-swipe.js?v=20260906b';
