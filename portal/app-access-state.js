...
if(!document.querySelector('script[data-uat-phase-workspace-v2]')){const workspace=document.createElement('script');workspace.src='./uat-phase-workspace-v2.js?v=20260909a';workspace.dataset.uatPhaseWorkspaceV2='1';document.head.appendChild(workspace)}
})();